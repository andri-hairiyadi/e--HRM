...
<?php echo $this->load->view('manpower/tampilan_menu');?>
        <!-- top navigation -->
        <div class="top_nav " >
          <div class="nav_menu">
            <nav>
...
<?php
    ...
    ?>
                  ...
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="<?php echo base_url();?>style/dokumen_pelamar/<?php echo $row->file_photo; ?>" alt=""><?php echo $row->nama_mp; ?>
         ...
         ?>
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    <li>
                      <a href="<?php echo base_url();?>manpower/setting">

...
<div class="right_col" role="main" >
    ...
    ?>
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" enctype="multipart/form-data" action="<?php echo base_url();?>manpower/setting/update">

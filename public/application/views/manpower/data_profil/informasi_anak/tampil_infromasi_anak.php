<?php echo $this->load->view('manpower/data_profil/informasi_anak/tambah_informasi_anak');?> 
<?php echo $this->load->view('manpower/data_profil/informasi_anak/ubah_informasi_anak');?>
    ...
    ?>
                <h3><i class="fa fa-user"></i> Data Informai Anak &nbsp;<small><i class="fa fa-angle-double-right"></i> <?php echo $row->nama_mp; ?></small>
                </h3>
                <?php } ?>
              </div>
 ...
 <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <a href="#" data-toggle="modal" data-target="#tambah_anak" class="btn btn-primary pull-right" style="margin-right: 5px;"><i class="fa fa-plus"></i>&nbsp;Tambah Data</a>
...
<?=$this->session->flashdata('pesan')?>
    ...
    ?>   
                              ...
                              <td>                              
                             <a href="#" data-toggle="modal" data-target="#ubah_anak<?php echo $data->id_anak; ?>"class="btn btn-info btn-xs"><i class="fa fa-edit"></i> Ubah </a>
                              <a href="" data-toggle="modal" data-target="#hapus<?php echo $data->id_anak; ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Hapus </a>
                          
                          </td>
                    
                        </tr>
<div id="hapus<?php echo $data->id_anak; ?>"  class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
       ...
       <div class="modal-content" style="background-image:url(<?php echo base_url();?>style/images/pop_up.jpg)" >
        ...
        <!-- /page content -->
          ...
          <div class="modal-footer">
            ...
            <a href="<?php echo base_url()?>manpower/data_profil/hapus_informasi_anak/<?php echo $data->id_anak; ?>" class="btn btn-danger antosubmit"><i class="fa fa-trash-o"></i>&nbsp;Iya, Hapus</a>

<?php echo $this->load->view('manpower/data_profil/informasi_saudara/tambah_informasi_saudara');?> 
<?php echo $this->load->view('manpower/data_profil/informasi_saudara/ubah_informasi_saudara');?>
    ...
    ?>
                <h3><i class="fa fa-user"></i> Data Informai Saudara &nbsp;<small><i class="fa fa-angle-double-right"></i> <?php echo $row->nama_mp; ?></small>
                </h3>
                <?php } ?>
              </div>
 ...
 <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <a href="#" data-toggle="modal" data-target="#tambah_saudara" class="btn btn-primary pull-right" style="margin-right: 5px;"><i class="fa fa-plus"></i>&nbsp;Tambah Data</a>
...
<?=$this->session->flashdata('pesan')?>
                  ...
                  <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                            <tr style="background-color:#4b5f71; color:#ffffff;">
                              ...
                              <td width="16,7%" align="center">Aksi</td>
                            </tr>
                            <tr>
                             <?php
    if ($saudara->result()) {
    ...
    ?>       
                              ...
                              <td>                              
                             <a href="#" data-toggle="modal" data-target="#ubah_saudara<?php echo $data->id_saudara; ?>"class="btn btn-info btn-xs"><i class="fa fa-edit"></i> Ubah </a>
                              <a href="" data-toggle="modal" data-target="#hapus<?php echo $data->id_saudara; ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Hapus </a>
                          
                          </td>
                    
                        </tr>
<div id="hapus<?php echo $data->id_saudara; ?>"  class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
       ...
       <div class="modal-content" style="background-image:url(<?php echo base_url();?>style/images/pop_up.jpg)" >
        ...
        <!-- /page content -->
          ...
          <div class="modal-footer">
            ...
            <a href="<?php echo base_url()?>manpower/data_profil/hapus_informasi_saudara/<?php echo $data->id_saudara; ?>" class="btn btn-danger antosubmit"><i class="fa fa-trash-o"></i>&nbsp;Iya, Hapus</a>

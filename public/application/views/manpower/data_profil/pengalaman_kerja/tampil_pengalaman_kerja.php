<?php echo $this->load->view('manpower/data_profil/pengalaman_kerja/tambah_pengalaman_kerja');?> 
<?php echo $this->load->view('manpower/data_profil/pengalaman_kerja/ubah_pengalaman_kerja');?>
    ...
    ?>
                <h3><i class="fa fa-user"></i> Data Pengalaman Kerja &nbsp;<small><i class="fa fa-angle-double-right"></i> <?php echo $row->nama_mp; ?></small>
                </h3>
                <?php } ?>
              </div>
 ...
 <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <a href="#" data-toggle="modal" data-target="#tambah_pengalaman" class="btn btn-primary pull-right" style="margin-right: 5px;"><i class="fa fa-plus"></i>&nbsp;Tambah Data</a>
   ...
   if ($pengalaman->result()) {
    ...
    ?>   
                              ...
                              <td><?php echo $data->alasan_keluar;?></td>
                                ...
                                <td>
                        <a href="#" data-toggle="modal" data-target="#ubah_pengalaman<?php echo $data->id_pengalaman; ?>"class="btn btn-info btn-xs"><i class="fa fa-edit"></i> Ubah </a>
                            <a href="" data-toggle="modal" data-target="#hapus<?php echo $data->id_pengalaman; ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Hapus </a>
                          
                          </td>
                    
                        </tr>
<div id="hapus<?php echo $data->id_pengalaman; ?>"  class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
       ...
       <div class="modal-content" style="background-image:url(<?php echo base_url();?>style/images/pop_up.jpg)" >
        ...
        <!-- /page content -->
          ...
          <div class="modal-footer">
            ...
            <a href="<?php echo base_url()?>manpower/data_profil/hapus_pengalaman_kerja/<?php echo $data->id_pengalaman; ?>" class="btn btn-danger antosubmit"><i class="fa fa-trash-o"></i>&nbsp;Iya, Hapus</a>

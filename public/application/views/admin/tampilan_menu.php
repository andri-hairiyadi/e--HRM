      ...
      <div class="modal-dialog">
        ...
        <!-- /page content -->
          ...
          <div class="modal-footer" >
            ...
            <a href="<?php echo base_url();?>admin/beranda/logout" class="btn btn-danger antosubmit"><i class="fa fa-power-off"></i>&nbsp;Iya</a>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="<?php echo base_url();?>admin/beranda"><i class="fa fa-home"></i>Dashboard</a>
                   
                  </li>
                   <li><a href="<?php echo base_url();?>admin/persebaran_area"><i class="fa fa-map-marker"></i>Persebaran Area</a></li>
                   
                
                  <li><a href="<?php echo base_url();?>admin/data_man_power"><i class="fa fa-user"></i>Data Man Power</a>
                   
                  </li>
                  <li><a href="<?php echo base_url();?>admin/data_area_kerja"><i class="fa fa-bank"></i>Data Area Kerja</a>
                   
                  </li>
                  
                   
                  </li>
                  <li><a href="<?php echo base_url();?>admin/data_pengguna"><i class="fa fa-key"></i>Data Pengguna Sistem</a>

...
<?php echo $this->load->view('admin/history_man_power/ubah_riwayat_pekerjaan');?>
 ...
 <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                   ...
                   <a href="<?php echo base_url();?>admin/history_man_power/" class="btn btn-dark pull-right" style="margin-right: 5px;"><i class="fa fa-arrow-left"></i>&nbsp;Kembali</a>    
                    </ul>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
       ...
       <div class="modal-content" style="background-image:url(<?php echo base_url();?>style/images/pop_up.jpg)" >
        ...
        <!-- /page content -->
          ...
          <div class="modal-footer">
            ...
            <a href="<?php echo base_url()?>admin/history_man_power/hapus_history/<?php echo $data->id_riwayat; ?>" class="btn btn-danger antosubmit"><i class="fa fa-trash-o"></i>&nbsp;Iya, Hapus</a>

    ...
    <div class="right_col" role="main" style="background-image:url(<?php echo base_url();?>style/images/latar.jpg)" >
         <div class="">
            <div class="page-title">
              ...
              <h3><i class="fa fa-key"></i> Data Pengguna Sistem&nbsp;<small><i class="fa fa-angle-double-right"></i> <b>Admin</b></small></h3>
...
<div class="clearfix"></div>
 ...
 <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                 ...
                 <a href="<?php echo base_url();?>admin/data_pengguna/tambah_admin" class="btn btn-dark pull-right" style="margin-right: 5px;"><i class="fa fa-plus"></i>&nbsp;Tambah User</a>
...
<!---foreach-->  <?php
                          ...
                          <td>
                        <a href="<?php echo base_url()?>admin/data_pengguna/ubah_admin/<?php echo $row->id_user; ?>" class="btn btn-info btn-xs"><i class="fa fa-edit"></i> Ubah </a>
       ...
       <div class="modal-content" style="background-image:url(<?php echo base_url();?>style/images/pop_up.jpg)" >
        ...
        <!-- /page content -->
          ...
          <div class="modal-footer">
            ...
            <a href="<?php echo base_url()?>admin/data_pengguna/hapus_admin/<?php echo $row->id_user; ?>" class="btn btn-danger antosubmit"><i class="fa fa-trash-o"></i>&nbsp;Iya, Hapus</a>

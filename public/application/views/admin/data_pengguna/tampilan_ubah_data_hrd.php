  ...
  <div class="">
            <div class="page-title">
              <div class="title_left">
                ...
                <h3><i class="fa fa-key"></i> Data Pengguna Sistem&nbsp;<small><i class="fa fa-angle-double-right"></i> <b>HRD</b> <i class="fa fa-angle-double-right"></i> Ubah</small></h3>
              </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <?php
                            ...
                            ?>
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"  enctype="multipart/form-data" method="post"action="<?php echo base_url();?>admin/data_pengguna/update_hrd">

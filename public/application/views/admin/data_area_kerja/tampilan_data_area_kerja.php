 ...
 <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <a href="<?php echo base_url();?>admin/data_area_kerja/cetak_area_kerja" target="__blank" class="btn btn-dark pull-right" style="margin-right: 5px;"><i class="fa fa-print"></i>&nbsp;Cetak Data Area Kerja</a>

                    <a href="<?php echo base_url();?>admin/data_area_kerja/tambah" class="btn btn-primary pull-right" style="margin-right: 5px;"><i class="fa fa-plus"></i>&nbsp;Tambah Data</a>
                  ...
                  <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                          <a href="<?php echo base_url()?>admin/data_area_kerja/detail/<?php echo $row->id_area_kerja; ?>" class="btn btn-success btn-xs"><i class="fa fa-search"></i> Detail </a>
                         <a href="<?php echo base_url()?>admin/data_area_kerja/ubah/<?php echo $row->id_area_kerja; ?>" class="btn btn-info btn-xs"><i class="fa fa-edit"></i> Ubah </a>
       ...
       <div class="modal-content" style="background-image:url(<?php echo base_url();?>style/images/pop_up.jpg)" >
        ...
        <!-- /page content -->
          ...
          <div class="modal-footer">
            ...
            <a href="<?php echo base_url()?>admin/data_area_kerja/hapus/<?php echo $row->id_area_kerja; ?>" class="btn btn-danger antosubmit"><i class="fa fa-trash-o"></i>&nbsp;Iya, Hapus</a>

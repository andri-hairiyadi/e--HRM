              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_content">
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"  enctype="multipart/form-data" method="post"action="<?php echo base_url();?>admin/data_man_power/simpan">
 ...
 <div class="well" style="overflow: auto">        
  ...
  <div class="well" style="overflow: auto">                    
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="last-name" name="no_identitas" required="required" placeholder="Masukan Nomor Identitas (KTP) / SIM" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">

         ...
         <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3><i class="fa fa-user"></i> Data Man Power
                </h3>
              </div>
 ...
 <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <a href="<?php echo base_url();?>admin/data_man_power/cetak_man_power" target="__blank" class="btn btn-dark pull-right" style="margin-right: 5px;"><i class="fa fa-print"></i>&nbsp;Cetak Data Man Power</a>

                    <a href="<?php echo base_url();?>admin/data_man_power/tambah" class="btn btn-primary pull-right" style="margin-right: 5px;"><i class="fa fa-plus"></i>&nbsp;Tambah Data</a>
                  ...
                  <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        <tr>
                         ...
                         <a href="<?php echo base_url()?>admin/data_man_power/ubah/<?php echo $row->id_man_power; ?>" class="btn btn-info btn-xs"><i class="fa fa-edit"></i> Ubah </a>
       ...
       <div class="modal-content" style="background-image:url(<?php echo base_url();?>style/images/pop_up.jpg)" >
        ...
        <!-- /page content -->
          ...
          <div class="modal-footer">
            ...
            <a href="<?php echo base_url()?>admin/data_man_power/hapus/<?php echo $row->id_man_power; ?>" class="btn btn-danger antosubmit"><i class="fa fa-trash-o"></i>&nbsp;Iya, Hapus</a>

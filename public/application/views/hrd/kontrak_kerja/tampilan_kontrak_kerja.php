 ...
 <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <a href="<?php echo base_url();?>admin_yayasan/data_psb/cetak" target="_blank" class="btn btn-dark pull-right" style="margin-right: 5px;"><i class="fa fa-print"></i>&nbsp;Cetak Data Kontrak Kerja</a>
                    <form action="<?php echo site_url('hrd/kontrak_kerja/posisi');?>" data-parsley-validate method="post" class="form-horizontal">
                   ...
                   <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><?php echo $row->jk_mp; ?></td>
                          <td><?php
                            $posisi = $row->posisi_pilihan;
                            if ($posisi == "") {
                              echo "<span class='label label-danger'>Belum Ada Posisi</span>";
                            }
                            else{
                              echo $posisi;
                            }
                           ...
                           ?></td>
                          <td><span class="label label-danger">Kontrak Kerja Belum Dilakukan</span></td>

                          <td>
                         <a href="" data-toggle="modal" data-target="#kontrak<?php echo $row->id_man_power; ?>" class="btn btn-primary btn-xs"><i class="fa fa-list"></i> Lakukan Kontrak Kerja </a>
       ...
       <div class="modal-content" style="background-image:url(<?php echo base_url();?>style/images/pop_up.jpg)" >
        ...
        <!-- /page content -->
          ...
          <div class="modal-footer">
            ...
            <a href="<?php echo base_url()?>hrd/kontrak_kerja/hapus/<?php echo $row->id_man_power; ?>" class="btn btn-danger antosubmit"><i class="fa fa-trash-o"></i>&nbsp;Iya, Hapus</a>

  ...
  <div class="">
            <div class="page-title">
              <div class="title_left">
                ...
                <h3><i class="fa fa-book"></i> Data User&nbsp;<small><i class="fa fa-angle-double-right"></i> Tambah</small></h3>
              </div>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_content">
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"  enctype="multipart/form-data" method="post"action="<?php echo base_url();?>admin_yayasan/data_user/simpan">

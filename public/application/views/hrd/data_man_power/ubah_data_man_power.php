              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_content">
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"  enctype="multipart/form-data" method="post"action="<?php echo base_url();?>hrd/data_man_power/ubah_simpan">
 ...
 <div class="well" style="overflow: auto">
                        ...
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Photo
                          ...
                          <input type="file" id="last-name" name="filefoto" class="form-control col-md-7 col-xs-12" onchange="readURL01(this);">
                              <img src="<?php echo base_url();?>style/dokumen_pelamar/<?php echo $data->file_photo;?>" id="preview1" alt="Preview Image" style="width: 300px; height: 400px;" />
...
<div class="well" style="overflow: auto">
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="last-name" name="bpjs_ketenagakerjaan" value="<?php echo $data->no_bpjs_kes; ?>"  placeholder="Masukan Nomor BPJS Ketenagakerjaan" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="last-name" name="bpjs_kesehatan" value="<?php echo $data->no_bpjs_kes; ?>"   placeholder="Masukan Nomor BPJS Kesehatan" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>

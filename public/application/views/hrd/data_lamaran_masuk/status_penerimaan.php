     ...
     <div id="status<?php echo $data->id_pelamar; ?>"  class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-dialog">
       ...
       <div class="modal-body">
        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="<?php echo base_url();?>admin_yayasan/data_psb/status_penerimaan">
          <input type="hidden" id="first-name" placeholder="" class="form-control col-md-7 col-xs-12" name="id_psb" value="<?php echo $data->id_pelamar; ?>">       
          <input type="hidden" id="first-name" placeholder="" class="form-control col-md-7 col-xs-12" name="no_hp" value="<?php echo $data->no_hp; ?>">       
          <input type="hidden" id="first-name" placeholder="" class="form-control col-md-7 col-xs-12" name="nama_lengkap" value="<?php echo $data->nama_pelamar; ?>">       
          <input type="hidden" id="first-name" placeholder="" class="form-control col-md-7 col-xs-12" name="sekolah" value="<?php echo $data->posisi; ?>">       
          ...
          <input type="hidden" id="first-name" placeholder="" class="form-control col-md-7 col-xs-12" name="jenis_kelamin" value="<?php echo $data->jenis_kelamin; ?>">       

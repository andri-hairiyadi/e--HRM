 ...
 <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <a href="<?php echo base_url();?>admin_yayasan/data_psb/cetak" target="_blank" class="btn btn-dark pull-right" style="margin-right: 5px;"><i class="fa fa-print"></i>&nbsp;Cetak Data Training</a>
                        ...
                        <tr>
                          ...
                          <?php
                            if ($row->status == '0') {
                             ...
                             echo "<span class='label label-primary'>Taining</span>";
                            }

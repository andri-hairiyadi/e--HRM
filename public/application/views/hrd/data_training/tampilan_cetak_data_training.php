<style>
#cetak{
    background-image: url(style/images/cetak_data_training.jpg);
    height: 300px;
}
...
?></b></font>
                 ...
                 <table>
                      ...
                      <tbody>
                          ...
                          <td width="150" align="center"><?php echo tgl_indo($row->tanggal_training); ?></td>
                          <td width="100" align="center"><?php echo $row->jam_training; ?></td>
                          <td width="100" align="center"><?php echo $row->no_hp; ?></td>

...
<?php echo $this->load->view('hrd/data_training/status_ditolak');?>
<?php echo $this->load->view('hrd/data_training/status_diterima');?>
    ...
    ?>
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <a href="<?php echo base_url();?>hrd/data_training" class="btn btn-dark pull-right" style="margin-right: 5px;"><i class="fa fa-arrow-left"></i>&nbsp;Kembali</a>               
                  </ul>
                  ...
                  <table border="0" width="100%">
                    <tr>
                      <td width="15%" colspan="3" style="background-color:#4b5f71; color:#ffffff;"><b>Training Tahap 1</b></td>
                    </tr>
                    <tr>
                      <td width="15%"> Catatan HRD :</td>
                      <td width="2%">:</td>
                      <td width="88%">
                        <?php
                    ...
                    <tr>
                      <td width="15%" colspan="3" style="background-color:#4b5f71; color:#ffffff;"><b>Training Tahap 2</b></td>
                    </tr>
                    <tr>

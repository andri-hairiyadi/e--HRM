...
<html lang="en">
 ...
 <!--
<link rel="stylesheet" type="text/css" href="<?php // echo base_url();?>style/clock/assets/css/bootstrap.min.css">
<link rel="stylesheet" type="text/css" href="<?php // echo base_url();?>style/clock/dist/bootstrap-clockpicker.min.css">
<link rel="stylesheet" type="text/css" href="<?php // echo base_url();?>style/clock/assets/css/github.min.css">
-->
...
<?php echo $this->load->view('hrd/tampilan_menu');?>
        <!-- top navigation -->
        <div class="top_nav " >
          <div class="nav_menu">
            <nav>
...
<?php
    ...
    ?>
                  ...
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="<?php echo base_url();?>style/images/user/<?php echo $row->photo; ?>" alt=""><?php echo $row->nama_user; ?>
         ...
         ?>
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    ...
                    <li>
                      <a href="<?php echo base_url();?>hrd/setting">

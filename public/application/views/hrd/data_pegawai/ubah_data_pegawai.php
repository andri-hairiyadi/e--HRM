  ...
  <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3><i class="fa fa-book"></i> Data Pegawai&nbsp;<small><i class="fa fa-angle-double-right"></i> Ubah</small></h3>
              </div>
...
<?=$this->session->flashdata('pesan')?>
             ...
             <input type="hidden" id="last-name" name="id_pegawai" required="required" value="<?php echo $data->id_pegawai?>" class="form-control col-md-7 col-xs-12">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select class="form-control" required="required" name="id_sekolah" tabindex="-1" required="required">
                            ...
                            <?php
                              ...
                              ?>
                            <option value="<?php echo $row->id_sekolah; ?>" <?php if($data->id_sekolah == $row->id_sekolah ) { echo 'selected'; } ?>><?php echo $row->nama_sekolah; ?></option>
                              <?php } ?>
                          </select>
                        </div>
                      </div>

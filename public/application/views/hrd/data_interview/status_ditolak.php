     ...
     <div id="tolak<?php echo $data->id_pelamar; ?>"  class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-dialog">
       ...
       <div class="modal-body">
        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="<?php echo base_url();?>hrd/data_interview/status_ditolak">
              ...
              <div class="well" style="overflow: auto">
                 ...
                 <div class="well" style="overflow: auto">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            <textarea id="message" required="required" placeholder="Masukan Catatan Untuk Pelamar" rows="8" name="catatan_interview" class="form-control"></textarea>

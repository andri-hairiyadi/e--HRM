         ...
         <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3><i class="fa fa-sign-in"></i> Data Interview
                </h3>
              </div>
 ...
 <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <a href="<?php echo base_url();?>hrd/data_interview/cetak_data_interview" target="_blank" class="btn btn-dark pull-right" style="margin-right: 5px;"><i class="fa fa-print"></i>&nbsp;Cetak Data Interview</a>
                  <form action="<?php echo site_url('hrd/data_interview/posisi');?>" data-parsley-validate method="post" class="form-horizontal">
                  ...
                  <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><?php echo tgl_indo($row->tanggal_interview); ?></td>
                          <td><?php echo $row->jam_interview; ?></td>
                          ...
                          <?php
                            if ($row->status == '0') {
                             ...
                             echo "<span class='label label-warning'>Belum Interview</span>";
                            }
                             else if ($row->status == '3') {
                             echo "<span class='label label-success'>Sudah Interview</span>";
                            }
                         ...
                         <a href="<?php echo base_url()?>hrd/data_interview/detail/<?php echo $row->id_pelamar; ?>" class="btn btn-info btn-xs <?php echo $disable;?>" ><i class="fa fa-search"></i> Detail </a>
       ...
       <div class="modal-content" style="background-image:url(<?php echo base_url();?>style/images/pop_up.jpg)" >
        ...
        <!-- /page content -->
          ...
          <div class="modal-footer">
            ...
            <a href="<?php echo base_url()?>hrd/data_interview/hapus/<?php echo $row->id_pelamar; ?>" class="btn btn-danger antosubmit"><i class="fa fa-trash-o"></i>&nbsp;Iya, Hapus</a>
          </div>
        </div>
      </div>
    </div>

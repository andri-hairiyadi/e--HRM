     ...
     <div id="terima<?php echo $data->id_pelamar; ?>"  class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-dialog">
       ...
       <div class="modal-body">
        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="<?php echo base_url();?>hrd/data_interview/status_diterima">
     ...
     <div class="well" style="overflow: auto">
        ...
        <!-- /page content -->
          ...
          <button type="submit" class="btn btn-primary antosubmit"><i class="fa fa-check"></i>&nbsp;Konfirmasi Jadwal Training </button>

...
<?php echo $this->load->view('hrd/data_interview/catatan_hrd');?>
<?php echo $this->load->view('hrd/data_interview/status_ditolak');?>
<?php echo $this->load->view('hrd/data_interview/status_diterima');?>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                ...
                <h3><i class="fa fa-sign-in"></i> Data Interview&nbsp;<small><i class="fa fa-angle-double-right"></i> Detail</small></h3>
              </div>
    ...
    ?>
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <a href="<?php echo base_url();?>hrd/data_interview" class="btn btn-dark pull-right" style="margin-right: 5px;"><i class="fa fa-arrow-left"></i>&nbsp;Kembali</a>               
                  </ul>
               ...
               <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <table border="0" width="100%">
                    <tr>
                      <td width="10%"><b>Catatan HRD</b></td>
                      <td width="2%">:</td>
                      <td width="88%"><?php echo $data->catatan_hrd; ?></td>
                    </tr>
                  </table>
                   ...
                   <div class="col-md-4 col-sm-4 col-xs-12 profile_left">
                      ...
                      ?>
                          <div class="col-md-12 col-sm-12 col-xs-12">
                           ...
                           <a href="" data-toggle="modal" data-target="#catatan<?php echo $data->id_pelamar; ?>" class="btn btn-primary btn-block"><i class="fa fa-edit"></i> Catatan HRD</a>
                    </div>

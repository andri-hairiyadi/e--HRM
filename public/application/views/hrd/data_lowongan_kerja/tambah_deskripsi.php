    ...
    <div id="tambah_deskripsi"  class="modal fade"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
         ...
         <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post"action="<?php echo base_url();?>hrd/data_lowongan_kerja/simpan_deskripsi">
                 ...
                 <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                          <textarea id="message" rows="10" required="required" name="deskripsi" placeholder="Masukan Deskripsi Lowongan"  class="form-control"></textarea>

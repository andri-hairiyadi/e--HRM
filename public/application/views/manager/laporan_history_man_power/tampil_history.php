...
<div class="clearfix"></div>
 ...
 <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                 ...
                 <a href="<?php echo base_url();?>manager/laporan_history_man_power/" class="btn btn-dark pull-right" style="margin-right: 5px;"><i class="fa fa-arrow-left"></i>&nbsp;Kembali</a>    
        <?php

    foreach ($riwayat->result() as $data) {
    ?>
                    <a href="<?php echo base_url();?>manager/laporan_history_man_power/cetak_history/<?php echo $data->id_kontrak;?>" target="__blank" class="btn btn-primary pull-right" style="margin-right: 5px;"><i class="fa fa-print"></i>&nbsp;Cetak History Man Power</a>
   <?php

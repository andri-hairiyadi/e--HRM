         ...
         <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3><i class="fa fa-history"></i> History Man Power
                </h3>
              </div>
                  ...
                  <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                          <a href="<?php echo base_url()?>manager/laporan_history_man_power/history/<?php echo $row->id_man_power; ?>" class="btn btn-success btn-xs"><i class="fa fa-search"></i> Lihat History Man Power </a>
                                                </td>

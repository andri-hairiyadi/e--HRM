...
<?=$this->session->flashdata('pesan')?>
              ...
              <tr>
                          ...
                          <td>
                            ...
                            if ($tgl_now > $batas){
                               echo "<span class='label label-danger'>- ". dateDiff("$batas 00:00:00", "$tgl_now 00:00:00",3) . "</span>";
                            }
                            else{
                          ...
                          <td>
                            ...
                            <a href="" data-toggle="modal" data-target="#kontrak<?php echo $row->id_kontrak; ?>" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Ubah Kontrak Kerja </a>

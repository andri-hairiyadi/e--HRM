          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3><i class="fa fa-suitcase"></i> Laporan Data Kontrak Kerja&nbsp;<small><i class="fa fa-angle-double-right"></i> Detail</small></h3>
              </div>
    ...
    ?>
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <a href="<?php echo base_url();?>manager/laporan_kontrak_kerja" class="btn btn-dark pull-right" style="margin-right: 5px;"><i class="fa fa-arrow-left"></i>&nbsp;Kembali</a>
                  </ul>

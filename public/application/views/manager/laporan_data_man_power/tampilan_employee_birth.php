         ...
         <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3><i class="fa fa-birthday-cake"></i> Employee Birth
                </h3>
              </div>
                  ...
                  <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><?php echo tgl_indo($row->tanggal_lahir_mp); ?></td>
                      ...
                      <?php } } else{
                      	echo "<tr><td colspan='8'><font color='red'>Data Tidak Ada</font></td></tr>";

  ...
  <div class="row top_tiles" >
                  ...
                  <a href="<?php echo base_url(); ?>manager/laporan_data_man_power/aktif" class="btn btn-default btn-sm">Lihat Selengkapnya <i class="fa fa-arrow-right"></i></a>
                  ...
                  <div class="tile-stats" style="box-shadow: 0 0 2px 0 #2a3f54;">
                    ...
                    <a href="<?php echo base_url(); ?>manager/laporan_data_man_power/non_aktif" class="btn btn-default btn-sm">Lihat Selengkapnya <i class="fa fa-arrow-right"></i></a>
                ...
                <div class="tile-stats" style="box-shadow: 0 0 2px 0 #2a3f54;">
                  ...
                  <a href="<?php echo base_url(); ?>manager/laporan_area_kerja" class="btn btn-default btn-sm">Lihat Selengkapnya <i class="fa fa-arrow-right"></i></a>
              ...
              <a href="<?php echo base_url(); ?>manager/kontrak_kerja" class="btn btn-default btn-sm">Lihat Selengkapnya <i class="fa fa-arrow-right"></i></a>

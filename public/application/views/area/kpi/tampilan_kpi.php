                  ...
                  <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        <tr>
                          ...
                          $kpi = $row->kpi;
                          if ($kpi == '0') {
                             echo "<span class='label label-danger'>Penilaiam Belum Ada</span>";
                          }
                          else{
                            echo "<b>Toral Penilaian : $kpi</b>";
                            echo "<br>";
                             if ($kpi <= '4' )
                                {
                          ...
                          <td>
                          <a href="<?php echo base_url()?>area/kpi/detail/<?php echo $row->id_man_power; ?>" class="btn btn-success btn-xs"><i class="fa fa-search"></i> Detail Penilaian </a>
                                                </td>

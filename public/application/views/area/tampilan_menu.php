      ...
      <div class="modal-dialog">
        ...
        <!-- /page content -->
          ...
          <div class="modal-footer" >
            ...
            <a href="<?php echo base_url();?>area/beranda/logout" class="btn btn-danger antosubmit"><i class="fa fa-power-off"></i>&nbsp;Iya</a>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="<?php echo base_url();?>area/beranda"><i class="fa fa-home"></i>Beranda</a>

                  </li>

                  <li><a href="<?php echo base_url();?>area/data_profil"><i class="fa fa-bank"></i>Profil Area</a>

                  </li>
                  <li><a href="<?php echo base_url();?>area/data_man_power"><i class="fa fa-user"></i>Data Man Power</a>

                  </li>
                  <li><a href="<?php echo base_url();?>area/data_training"><i class="fa fa-sign-in"></i>Data Training</a>

                  </li>

                <li><a href="<?php echo base_url();?>area/kpi"><i class="fa fa-book"></i>Key Performance Indicator</a></li>

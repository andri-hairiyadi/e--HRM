...
reader.readAsDataURL(input.files[0]);
    ...
    <div id="ubah_photo<?php echo $data->id_user;?>"  class="modal fade"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
      <div class="modal-dialog">
        ...
        <div class="modal-body">
         ...
         <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>area/data_profil/ubah_photo_profil">
                        ...
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Photo 
                          ...
                          <input type="hidden" id="last-name" name="id_user" required="required" value="<?php echo $data->id_user?>" placeholder="Masukan Nama Anggota" class="form-control col-md-7 col-xs-12">
                          ...
                          <input type="file" id="last-name" name="filefoto" class="form-control col-md-7 col-xs-12" onchange="readURL01(this);">
                              <img src="<?php echo base_url();?>style/images/user/<?php echo $data->photo;?>" id="preview1" alt="Preview Image" style="width: 300px; height: 400px;" />

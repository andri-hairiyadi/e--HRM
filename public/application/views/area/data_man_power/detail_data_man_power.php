    ...
    ?>
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <a href="<?php echo base_url();?>area/data_man_power" class="btn btn-dark pull-right" style="margin-right: 5px;"><i class="fa fa-arrow-left"></i>&nbsp;Kembali</a>
                  </ul>

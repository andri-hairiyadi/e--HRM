 ...
 <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <a href="<?php echo base_url();?>area/data_man_power/cetak_man_power" target="__blank" class="btn btn-dark pull-right" style="margin-right: 5px;"><i class="fa fa-print"></i>&nbsp;Cetak Data Man Power</a>
                  ...
                  <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                          <a href="<?php echo base_url()?>area/data_man_power/detail/<?php echo $row->id_man_power; ?>" class="btn btn-success btn-xs"><i class="fa fa-search"></i> Detail </a>

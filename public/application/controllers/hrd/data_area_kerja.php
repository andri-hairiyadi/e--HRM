...
public function __construct() {
	...
	{		 
		...
		$data['content']='hrd/data_area_kerja/tampilan_data_area_kerja';
	...
	{	
		...
		$data['id_user'] = $this->session->userdata('id_user');
		$data['data']	= $this->model_data_user->login_hrd();
		$data['content']='hrd/data_area_kerja/tampilan_tambah_data_area_kerja';
		...
		public function ubah($id)
	{
		...
		$data['content']='hrd/data_area_kerja/ubah_data_area_kerja';
		$this->load->view('hrd/tampilan_home_beranda',$data);
		...
		public function detail($id)
	{
		...
		$data['content']='hrd/data_area_kerja/detail_data_area_kerja';
		$this->load->view('hrd/tampilan_home',$data);
		...
		public function simpan()
  {
    ...
    $data['mp_kontrak']       = $this->input->post('mp_kontrak'); 

...
public function __construct() {
	...
	{		
		...
		$data['content']='hrd/data_man_power/tampilan_data_man_power';
  ...
  {   
	...
	{	
		...
		$data['id_user'] = $this->session->userdata('id_user');
		$data['data']	= $this->model_data_user->login_hrd();
		$data['content']='hrd/data_man_power/tampilan_tambah_data_man_power';
		$this->load->view('hrd/tampilan_home',$data);
	}
		...
		public function ubah($id)
	{
		...
		$data['content']='hrd/data_man_power/ubah_data_man_power';
		$this->load->view('hrd/tampilan_home',$data);
	...
	{ 
		...
		$data['content']='hrd/data_man_power/detail_data_man_power';
		$this->load->view('hrd/tampilan_home',$data);
       ...
       if($_FILES['filefoto']['name'])
       {
           if ($this->upload->do_upload('filefoto'))
           {
            ...
            $this->model_data_man_power->update_man_power($key1,$data1);
               ...
               redirect('hrd/data_man_power'); //jika berhasil maka akan ditampilkan view vupload
               ...
               redirect('hrd/data_man_power'); //jika gagal maka akan ditampilkan form upload
           }
           ...
           redirect('hrd/data_man_power'); /* jika berhasil maka akan kembali ke home upload */
       }
   }
